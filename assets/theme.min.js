    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productPrices.innerHTML += "<div class=\"discount__percentage\"><a><i style=\"font-size:12px\"class=\"fa-solid fa-arrow-down\"></i>&nbsp;</a>".concat(Math.round( ((newVariant['compare_at_price'] - newVariant['price'])*100.0)/newVariant['compare_at_price']  ), "%</div>");
            
            productPrices.innerHTML += "<br>";
            productPrices.innerHTML += "<p style=\"color: var(--text-color); margin: 3px 0px 0px 0px;\"> O en hasta  <b style=\"color: var(--text-color); font-size: 17px\">12 cuotas</b> de <b style=\"color: var(--text-color); font-size: 16px\">".concat(Currency.formatMoney(newVariant['price'] / 12 * 1.2161 , window.theme.moneyFormat), "</b></p>");
        <!--productPrices.innerHTML += "<div class=\"product-meta__label-list\"><span style=\"margin-top: 10px; font-size: 14px; margin-left: -0px; font-weight: bold;\" class=\"product-label product-label--on-sale\"><a><i style=\"font-size:12px\"class=\"fa-solid fa-tags\"></i>&nbsp;</a><b>Economia de</b> <span class=\"economia\">".concat(Currency.formatMoney((newVariant['compare_at_price']) - (newVariant['price']), window.theme.moneyFormat),"</span></span></div>");-->
        } else {
            productPrices.innerHTML += "<span class=\"price price--highlight\" data-money-convertible>".concat(Currency.formatMoney(newVariant['price'], window.theme.moneyFormat), "</span>");
            productPrices.innerHTML += "<p style=\"color: var(--text-color); margin: 3px 0px 0px 0px;\"> O en hasta  <b style=\"color: var(--text-color); font-size: 17px\">12 cuotas</b> de <b style=\"color: var(--text-color); font-size: 16px\">".concat(Currency.formatMoney(newVariant['price'] / 12 * 1.2161 , window.theme.moneyFormat), "</b></p>");
        }
