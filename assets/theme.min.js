    ...
    _createClass(ProductVariants, [{
      ...
      value: function _updateProductPrices(newVariant, previousVariant) {
        ...
        if (newVariant['compare_at_price'] > newVariant['price']) {
            ...
            productPrices.innerHTML += "<br>";
            productPrices.innerHTML += "<p style=\"color: var(--text-color); margin: 3px 0px 0px 0px;\"> o en hasta <b style=\"color: var(--text-color); font-size: 17px\">12x</b> de <b style=\"color: var(--text-color); font-size: 16px\">".concat(Currency.formatMoney(newVariant['price'] / 12 * 1.2161 , window.theme.moneyFormat), "</b></p>");
